...
Note that text classification can be used generally for nominal values, so you can also use it for classifying topic, frames, etc.
...
Since this takes a while to process, we save the reviews as an RDS file, which you can also download directly from [here](rawgit.com/vanatteveldt/learningr/master/data/reviews.rds):
